...
class CountdownBot extends Bot {
 	...
 	constructor(settings) {
 		...
 		this.eventDate = moment('2017-03-09').diff(new Date(), 'days');
 		this.openers = [
	...
	_welcomeMessage () {
	    this.postMessageToChannel(this.channels[0].name, 'Hi guys, The Count here.' + '\n I\'m a really impressive and super sophisticated piece of software that counts down to...well, anything you want, really! Invoke me by typing \\countdown or ' + this.name,
	        {as_user: true});
	}
