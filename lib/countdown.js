...
class CountdownBot extends Bot {
 	...
 	constructor(settings) {
 		...
 		this.daysToEvent = moment(settings.dateString).diff(new Date(), 'days');
 		this.openers = [
	...
	_generateResponse () {
		...
		return this._pickRandom(this.openers) + this.daysToEvent + this._pickRandom(this.enders) + destination + ' for the ' + this.eventName;
	}
