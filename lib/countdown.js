...
class CountdownBot extends Bot {
 	...
 	constructor(settings) {
 		...
 		this.eventDate.diff(new Date(), 'days'); = moment(settings.dateString);
 		this.openers = [
	...
	_generateResponse () {
		...
		return this._pickRandom(this.openers) + this.eventDate.diff(new Date(), 'days'); + this._pickRandom(this.enders) + destination + ' for the ' + this.eventName;
	}
