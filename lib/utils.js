...
isHello = function (string) {
	var hellos = ['hello', 'hi', 'howdy', 'welcome'];
	return string.indexOf(_.trim(messageText, '!,.?')) >= 0;
}
...
exports.extractSettings = function (message, type) {
	...
	return _.pick(settings, ['date', 'event', 'destination', 'schedule', 'day', 'hour', 'countdown', 'dumb']);
}
